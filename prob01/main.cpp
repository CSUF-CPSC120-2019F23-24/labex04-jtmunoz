  ...
  int main()
  {
    ...
    // No longer alphabetic because z is the last letter of the alphabet and b is the second letter
    ...
    short my_short2 = 32767; 
    int my_int2 = my_short2;

    std::cout << my_short2 << std::endl;
    std::cout <<  my_int2 << std::endl;

    std::cout << "Short (" << sizeof(my_short2) << " bytes): " << std::dec << my_short2 << std::hex << " (0x" << my_short2 << ')';
    my_short2 = my_short2 + 1;
    std::cout << ", after adding 1: " << std::dec << my_short2 << std::hex << " (0x" << my_short2 << ")\n";
    // my_short2 became negative due to overflow

    std::cout << "Int (" << sizeof(my_short2) << " bytes): " << std::dec << my_int2 << std::hex << " (0x" << my_int2 << ')';
    my_int2 =  my_int2 + 1;
    std::cout << ", after adding 1: " << std::dec << my_int2 << std::hex << " (0x" << my_int2 << ")\n";
    ...
    unsigned short my_short3 = 65535; 
    int my_int3 = my_short3;
    
    std::cout << my_short3 << std::endl;
    std::cout << my_int3 << std::endl;

    std::cout << "Unsigned short (" << sizeof(my_short3) << " bytes): " << std::dec << my_short3 << std::hex << " (0x" << my_short3 << ')';
    my_short3 = my_short3 + 1;
    std::cout << ", after adding 1: " << std::dec << my_short3 << std::hex << " (0x" << my_short3 << ")\n";

    std::cout << "Same value as int (" << sizeof(my_int3) << " bytes): " << std::dec << my_int3 << std::hex << " (0x" << my_int3 << ')';
    my_int3 =  my_int3 + 1;
    std::cout << ", after adding 1: " << std::dec << my_int3 << std::hex << " (0x" << my_int3 << ")\n";

    // I'm guessing this is referring to my_short3 and not my_short2, what I think is happening is promotion of my_short3 from usigned short to an int data type
